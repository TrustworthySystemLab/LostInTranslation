...
define void @astex_codelet__5(i32, i32, float, float* nocapture, i32, float* nocapture, float* nocapture, float* nocapture, i32* nocapture) local_unnamed_addr #0 {
  ...
  %. = select i1 %17, float %18, float %16
  %19 = fmul float %., %2
  store float %16, float* %3, align 4, !tbaa !3
  store float %., float* %5, align 4, !tbaa !3
  store float %19, float* %6, align 4, !tbaa !3
  store float %19, float* %7, align 4, !tbaa !3
