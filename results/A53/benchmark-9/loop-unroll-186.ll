...
vector.body:                                      ; preds = %vector.ph
  ...
  %85 = getelementptr inbounds i32, i32* %next.gep.1, i32 56
  ...
  %89 = getelementptr inbounds i32, i32* %next.gep.1, i32 8
  %90 = bitcast i32* %89 to <4 x i32>*
  %wide.load118.1 = load <4 x i32>, <4 x i32>* %90, align 4, !tbaa !3
  %91 = getelementptr inbounds i32, i32* %next.gep.1, i32 48
  ...
  %95 = getelementptr inbounds i32, i32* %next.gep.1, i32 16
  %96 = bitcast i32* %95 to <4 x i32>*
  %wide.load120.1 = load <4 x i32>, <4 x i32>* %96, align 4, !tbaa !3
  %97 = getelementptr inbounds i32, i32* %next.gep.1, i32 40
  ...
  %101 = getelementptr inbounds i32, i32* %next.gep.1, i32 24
  %102 = bitcast i32* %101 to <4 x i32>*
  %wide.load122.1 = load <4 x i32>, <4 x i32>* %102, align 4, !tbaa !3
  %103 = getelementptr inbounds i32, i32* %next.gep.1, i32 32
