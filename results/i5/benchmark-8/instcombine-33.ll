...
for.inc:                                          ; preds = %land.lhs.true, %for.body, %if.then
  %v.1 = phi i64 [ %1, %if.then ], [ %v.0, %land.lhs.true ], [ %v.0, %for.body ]
...
for.body12:                                       ; preds = %for.cond10
  ...
  br i1 %tobool15, label %for.inc26, label %land.lhs.true16

land.lhs.true16:                                  ; preds = %for.body12
  %cmp19 = icmp sgt i64 %3, %v.2
  br i1 %cmp19, label %for.inc26, label %land.lhs.true20

land.lhs.true20:                                  ; preds = %land.lhs.true16
  %cmp21 = icmp eq i32 %i.1, %c1.0
  br i1 %cmp21, label %for.inc26, label %if.then22

if.then22:                                        ; preds = %land.lhs.true20
  br label %for.inc26

for.inc26:                                        ; preds = %land.lhs.true20, %land.lhs.true16, %for.body12, %if.then22
  %v.3 = phi i64 [ %3, %if.then22 ], [ %v.2, %land.lhs.true20 ], [ %v.2, %land.lhs.true16 ], [ %v.2, %for.body12 ]
